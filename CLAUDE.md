...
**Experiment 10 is complete: built, complete-flow tested, and reviewed against its specification (§21 Step 10). Its line-by-line wording approval (§28.1) has not yet been done — the learner-facing text is a first draft. Per the owner's direction, one candidate remains before "Relativity of Time and Motion" is done and the project moves to Phase 2 ("Gravity and Curved Spacetime"): a fuller spacetime diagram, building on Experiments 8/9, that draws the rod's own frame as a second, tilted set of axes, requiring the Lorentz transformation. Next: Stage 1 of §23, to propose that experiment (working title: Experiment 11).**
